...
void XMLUtil::ToStr(int v, char* buffer, int _bufferSize) {
    TIXML_SNPRINTF(buffer, _bufferSize, "%d", v);
}


void XMLUtil::ToStr(unsigned v, char* buffer, int _bufferSize) {
    TIXML_SNPRINTF(buffer, _bufferSize, "%u", v);
}


void XMLUtil::ToStr(bool v, char* buffer, int _bufferSize) {
    TIXML_SNPRINTF(buffer, _bufferSize, "%d", v ? 1 : 0);
}
...
*/
void XMLUtil::ToStr(float v, char* buffer, int _bufferSize) {
    TIXML_SNPRINTF(buffer, _bufferSize, "%.8g", v);
}


void XMLUtil::ToStr(double v, char* buffer, int _bufferSize) {
    TIXML_SNPRINTF(buffer, _bufferSize, "%.17g", v);
}
